...
x = 0
# global = 1 - identifikátor používá jako název klíčové slovo
Global = 1
...
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - identifikátor obsahuje "@" a "."
hilda_sspu_opava_cz = 'Hilda Dokonalá'

password2 = 'TajneHeslo'

# 007agent = 'James Bond' - identifikátor začíná číslem
_007agent = 'James Bond'
