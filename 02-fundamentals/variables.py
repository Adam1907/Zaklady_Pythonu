...
print("Type:",type(students_count),"ID:",id(students_count))
print("Type:",type(rating),"ID:",id(rating))
print("Type:",type(is_published),"ID:",id(is_published))
...
"""&,|,^,~,<<,>>"""
#? Do proměnné myself_binary uložte binární číslo vytvořené na základě osmi prvních znaků z vašeho jména a příjmení (souhláska = 1, samohláska 0)"01011011"
#? Příklad - HildaDok: 10110101
myself_binary = 0b01011011
...
print("Binární součin čísla 0b11010 a 0b10110101 je",bin(0b11010+0b10110101))
